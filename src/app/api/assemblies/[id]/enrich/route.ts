        ...
        await fetch(
          `${url}/rest/v1/bom_line_items?id=eq.${item.id}`,
          {
            ...
            body: JSON.stringify({
              ...
              z2data_lifecycle_source: result.lifecycleSource,
              z2data_estimated_years_to_eol: result.estimatedYearsToEOL,
              z2data_lc_comment: result.lcComment,
              z2data_forecasted_obsolescence_year: result.forecastedObsolescenceYear,
              z2data_rohs_version: result.rohsVersion,
              z2data_reach_version: result.reachVersion,
              z2data_china_rohs: result.chinaRohs,
              z2data_tsca: result.tsca,
              z2data_ca_prop65: result.caProp65,
              z2data_scip_id: result.scipId,
              z2data_lead_free_status: result.leadFreeStatus,
              z2data_country_of_origin: result.countryOfOrigin,
              z2data_manufacturing_locations: result.manufacturingLocations,
              z2data_trade_codes: result.tradeCodes,
